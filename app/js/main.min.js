...
!(function (e, t) {
      ...
      function (e, t) {
        b.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (L[e] || b.uniqueSort(i), q.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (b.Callbacks = function (e) {
    ...
    b.extend({
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (M(e, a.done(s(n)).resolve, a.reject, !t),
    ...
    b.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = Y.get(o)), 1 === o.nodeType && !G.get(o, 'hasDataAttrs'))
          ) {
            for (n = a.length; n--; )
              a[n] &&
  ...
  function xe(e, t, n, r, i) {
    ...
    for (f.textContent = '', d = 0; (o = p[d++]); )
      if (r && b.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = re(o)), (a = ve(f.appendChild(o), 'script')), l && ye(a), n)
      )
  ...
  (b.event = {
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = b.event.handlers.call(this, u, l), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && k(t, 'input') && Ae(t, 'click', Ce),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && k(t, 'input') && Ae(t, 'click'), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Me(e, t, n) {
    for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || b.cleanData(ve(r)),
        r.parentNode &&
          (n && re(r) && ye(ve(r, 'script')), r.parentNode.removeChild(r));
    return e;
  }
  b.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (a = ve(s), r = 0, i = (o = ve(e)).length; r < i; r++)
          Pe(o[r], a[r]);
      if (t)
        if (n)
          for (o = o || ve(e), a = a || ve(s), r = 0, i = o.length; r < i; r++)
            Oe(o[r], a[r]);
        else Oe(e, s);
      return (
        (a = ve(s, 'script')).length > 0 && ye(a, !u && ve(e, 'script')), s
      );
    },
  ...
  function Ze(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      'margin' === n && (u += b.css(e, n + te[a], !0, i)),
        r
          ? ('content' === n && (u -= b.css(e, 'padding' + te[a], !0, i)),
            'margin' !== n &&
              (u -= b.css(e, 'border' + te[a] + 'Width', !0, i)))
          : ((u += b.css(e, 'padding' + te[a], !0, i)),
            'padding' !== n
              ? (u += b.css(e, 'border' + te[a] + 'Width', !0, i))
  ...
  b.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = Ve(s)), (a = b.cssHooks[t] || b.cssHooks[s]), void 0 === n)
        )
    ...
    b.each(['height', 'width'], function (e, t) {
      b.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !Ge.test(b.css(e, 'display')) ||
    ...
    (b.cssHooks.marginLeft = _e(d.reliableMarginLeft, function (e, t) {
      if (t)
        return (
      ...
      _default: {
        ...
        set: function (e) {
          b.fx.step[e.prop]
            ? b.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!b.cssHooks[e.prop] && null == e.elem.style[Ve(e.prop)])
            ? (e.elem[e.prop] = e.now)
          ...
          d))
            u ||
              (v
                ...
                : (v = G.access(e, 'fxshow', { display: l })),
              o && (v.hidden = !g),
              g && le([e], !0),
              p.done(function () {
                for (r in (g || le([e]), G.remove(e, 'fxshow'), d))
                  b.style(e, r, d[r]);
              })),
              (u = lt(g ? v[r] : 0, r, p)),
              r in v ||
  ...
  b.extend(b.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        3 !== r.nodeType &&
          8 !== r.nodeType &&
          !xt.test(m + b.event.triggered) &&
          (m.indexOf('.') > -1 &&
            ((x = m.split('.')), (m = x.shift()), x.sort()),
          (l = m.indexOf(':') < 0 && 'on' + m),
          ((t = t[b.expando]
            ? t
            : new b.Event(m, 'object' == typeof t && t)).isTrigger = i ? 2 : 3),
          (t.namespace = x.join('.')),
        ...
        if (!i && !p.noBubble && !g(r)) {
          for (
            u = p.delegateType || m, xt.test(u + m) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            y.push(a), (s = a);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = r[l]) && (r[l] = null),
              (b.event.triggered = m),
              t.isPropagationStopped() && d.addEventListener(m, bt),
              r[m](),
              t.isPropagationStopped() && d.removeEventListener(m, bt),
      ...
      ajax: function (t, n) {
        ...
        d.hasContent
          ...
          : ((p = d.url.slice(i.length)),
            d.data &&
              ...
              ((i += (Ct.test(i) ? '&' : '?') + d.data), delete d.data),
            !1 === d.cache &&
              ((i = i.replace(qt, '$1')),
        ...
        function S(t, n, a, u) {
          ...
          l ||
            ...
            !f &&
              b.inArray('script', d.dataTypes) > -1 &&
            ...
            f
              ? (d.ifModified &&
                ...
                204 === t || 'HEAD' === d.type
                  ...
                  : 304 === t
                  ? (C = 'notmodified')
                  : ((C = w.state), (p = w.data), (f = !(v = w.error))))
  ...
  b.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Ut.pop() || b.expando + '_' + Tt.guid++;
      return (this[e] = !0), e;
    },
  }),
    ...
    b.each(['top', 'left'], function (e, t) {
      b.cssHooks[t] = _e(d.pixelPosition, function (e, n) {
        if (n)
          return (n = $e(e, t)), Ie.test(n) ? b(e).position()[t] + 'px' : n;
      });
    }),
